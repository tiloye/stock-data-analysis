...
drop_down_options = pd.read_html("https://en.wikipedia.org/wiki/List_of_S%26P_500_companies")[0]["Symbol"].values.tolist()
        ...
        [
            dbc.Col(
                [
                    ...
                    html.Label("Select stock symbol and date range", style={"font-weight": "bold"}),
            ...
            dbc.Col(
                [
                    ...
                    dbc.Button("Get Data", n_clicks=0, id="get-data-button-state", className="m-2")
                ],
                lg=5,
                sm=12,
                align="end"
                ...
                [
                    ...
                    dbc.RadioItems(
                        ...
                        options=[
                            ...
                            {"label": "3M rolling cumulative return", "value": "3mcr"},
                            {"label": "6M rolling cumulative return", "value": "6mcr"},
...
@callback(
    ...
    [
        Input("stocks-dropdown", "search_value"),
...
def update_dropdown(search_value, existing_value):
    ...
    if not search_value:
        raise PreventUpdate
    return [o for o in drop_down_options if (search_value in o) or (o in (existing_value or []))]
...
def fetch_data(n_clicks, tickers, start_date, end_date):
    ...
    price_df = yf.download(tickers=tickers, start=start, end=end)["Adj Close"]
